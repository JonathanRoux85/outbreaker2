...
cpp_move_psi <- function(param, data, config, custom_ll = NULL, custom_prior = NULL) {
    .Call(`_outbreaker2_cpp_move_psi`, param, data, config, custom_ll, custom_prior)
}
...
cpp_prior_psi <- function(param, config, custom_function = NULL) {
    .Call(`_outbreaker2_cpp_prior_psi`, param, config, custom_function)
}
